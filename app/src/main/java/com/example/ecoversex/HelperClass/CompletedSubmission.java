...
public class CompletedSubmission {
    ...
    public CompletedSubmission(String submissionID, String proposedDate, String actualDate,String materialName, String weight, String pointAwarded, String status, String userID) {
